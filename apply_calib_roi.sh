...
#       for f in apply_calib_roi.sh calib_roi_api.py apply_calib_roi_patch.py calib_label_api.py dash_api.py door_calib.py nav_common.py gpu_door.py; do curl -fsSL -o /tmp/$f $B/$f; done
