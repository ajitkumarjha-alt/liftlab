#!/usr/bin/env python3
"""Mount calib_label_router in main.py (import + include_router), after ops_router. Anchored,
idempotent, backup-first — same shape as apply_dash_patch.py."""
import pathlib
import shutil
import time
...
], "calib_label_router", "main.py")
print("calib_label_router mount done")
