...
#       for f in apply_calib_run.sh calib_run_api.py apply_calib_run_patch.py calib_roi_api.py calib_cells_api.py calib_label_api.py door_calib.py gpu_door.py nav_common.py; do curl -fsSL -o /tmp/$f $B/$f; done
